...
<html>
    ...
    <body>
      ...
      <div class="container">
        ...
        <section class="site-cover" style="background: black; height: 1080px;" id="section-home">
       ...
       <div class="container">
        <div class="row align-items-center justify-content-center text-center site-vh-100">
          <div class="col-md-12">
            ...
            <h1  style="padding-top:100px;"class="site-heading site-animate mb-3">Menu</h1>
            <h2 class="h5 site-subheading mb-5 site-animate">Our menu include breakfast &amp; lunch.</h2>    
                  ...
                  <div class="col-md-6 site-animate">
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        ...
                        <h6 class="text-primary menu-price">1000 credit points</h6>
                      </div>
                    </div>
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        ...
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">900 credit points</h6>
                      </div>
                    </div>
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        ...
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">700 credit points</h6>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 site-animate">
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Italian Sauce Mushroom</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">2000 credit points</h6>
                      </div>
                    </div>
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Salted Fried Chicken</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">890 credit points</h6>
                      </div>
                    </div>
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Fried Potato w/ Garlic</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">970 credit points</h6>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6 site-animate">
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Fried Potato w/ Garlic</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">800 credit points</h6>
                      </div>
                    </div>
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Italian Sauce Mushroom</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">1450 credit points</h6>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 site-animate">
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Fried Potato w/ Garlic</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">670 credit points</h6>
                      </div>
                    </div>
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Italian Sauce Mushroom</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">1950 credit points</h6>
                      </div>
                    </div>
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Salted Fried Chicken</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">600 credit points</h6>
                      </div>
                    </div>
